...
if ($problem_name.Length -ge 5 -and ($problem_name.Substring(0, 5) -eq "ALDS1" -or $problem_name.Substring(0, 3) -eq "DPL"-or $problem_name.Substring(0, 3) -eq "GRL") -or $problem_name -match '^\d') {
