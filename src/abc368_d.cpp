...
//  * @return int Returns 1 if the angle is 90 degrees (perpendicular), 0 if the
//  angle is acute, and -1 if the angle is obtuse.
template <typename T>
...
/*--------------------------------------------------------
                     ...
                     ｡˚ (¦3ꇤ )3 ⋆｡˚✩
----------------------------------------------------------*/
template <typename T> bool isin(vector<T> V, T i) {
